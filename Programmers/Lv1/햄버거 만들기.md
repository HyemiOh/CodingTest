...
class Solution {
    fun solution(ingredient: IntArray): Int {
        ...
        while(text.contains(hamburger)) {
            val index = text.indexOf(hamburger)
            text = text.removeRange(index until index + hamburger.count())
            answer++
        }
        return answer
    }
...
- 시간초과,,, 계속 처음부터 검사를 해야되서 시간초과가 나온게 아닐까싶다.
